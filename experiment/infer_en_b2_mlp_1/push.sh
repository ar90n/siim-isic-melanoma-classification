...
export KKT_WANDB_PROJECT=isic2020_infer_en_b2_mlp_1
export KKT_KAGGLE_EXPERIMENT_NAME=en_b2_mlp_1
...
poetry run jupytext --to notebook  ${PROJ_ROOT}/runner/infer_tta.py
poetry run kkt push --target .runner.infer_test_tta
