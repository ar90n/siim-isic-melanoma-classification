...
export KKT_WANDB_PROJECT=isic2020_train_en_b4_mlp
...
poetry run jupytext --to notebook  ${PROJ_ROOT}/runner/train_efficientnet_b4_mlp.py
poetry run kkt push --target .runner.train_en_b4_mlp
