...
export KKT_WANDB_PROJECT=isic2020_train_en_mlp_2019
export KKT_KAGGLE_MODEL_NAME=en_b0_mlp
...
poetry run jupytext --to notebook  ${PROJ_ROOT}/runner/train_efficientnet_mlp_2019.py
poetry run kkt push --target .runner.train_en_mlp_2019
